...
export class Teller__createResult {
  value0: BigInt;
  value1: BigInt;
...
export class Teller__getTokenNameAndSymbolResult {
  value0: string;
  value1: string;
...
export class Teller__purchaseResult {
  value0: BigInt;
  value1: BigInt;
...
export class Teller__tokenMetadataResult {
  value0: boolean;
  value1: Address;
  value2: i32;
  value3: BigInt;
...
export class Teller extends ethereum.SmartContract {
  static bind(address: Address): Teller {
    return new Teller("Teller", address);
  }
  ...
  create(
    ...
    return new Teller__createResult(result[0].toBigInt(), result[1].toBigInt());
  }
  ...
  try_create(
    ...
    expiry_: BigInt,
    amount_: BigInt
  ): ethereum.CallResult<Teller__createResult> {
    let result = super.tryCall(
      "create",
      "create(address,uint48,uint256):(uint256,uint256)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new Teller__createResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  getTokenNameAndSymbol(tokenId_: BigInt): Teller__getTokenNameAndSymbolResult {
    let result = super.call(
    ...
    return new Teller__getTokenNameAndSymbolResult(
      result[0].toString(),
      result[1].toString()
    );
  }
  ...
  try_getTokenNameAndSymbol(
    tokenId_: BigInt
  ): ethereum.CallResult<Teller__getTokenNameAndSymbolResult> {
    let result = super.tryCall(
      "getTokenNameAndSymbol",
      "getTokenNameAndSymbol(uint256):(string,string)",
      [ethereum.Value.fromUnsignedBigInt(tokenId_)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Teller__getTokenNameAndSymbolResult(
        value[0].toString(),
        value[1].toString()
      )
    );
  ...
  purchase(
    ...
    return new Teller__purchaseResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_purchase(
    ...
    amount_: BigInt,
    minAmountOut_: BigInt
  ): ethereum.CallResult<Teller__purchaseResult> {
    let result = super.tryCall(
      "purchase",
      "purchase(address,address,uint256,uint256,uint256):(uint256,uint48)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Teller__purchaseResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  tokenMetadata(param0: BigInt): Teller__tokenMetadataResult {
    let result = super.call(
      "tokenMetadata",
    ...
    return new Teller__tokenMetadataResult(
      result[0].toBoolean(),
      result[1].toAddress(),
      result[2].toI32(),
      result[3].toBigInt(),
  ...
  try_tokenMetadata(
    param0: BigInt
  ): ethereum.CallResult<Teller__tokenMetadataResult> {
    let result = super.tryCall(
      "tokenMetadata",
      "tokenMetadata(uint256):(bool,address,uint8,uint48,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Teller__tokenMetadataResult(
        value[0].toBoolean(),
        value[1].toAddress(),
        value[2].toI32(),
        value[3].toBigInt(),
